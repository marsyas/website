...
BLOG_AUTHOR = "Jakob Leben"
BLOG_TITLE = "Marsyas"
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://marsyas.info/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://getnikola.com/"
BLOG_EMAIL = "jakob.leben@gmail.com"
BLOG_DESCRIPTION = "Marsyas Software Framework"
    ...
    DEFAULT_LANG: (
        (
          (
            ...
            ('/about/demos.html', 'Demos'),
            ('http://marsology.blogspot.com/', 'Blog'),
            ('/about/publications.html', 'Publications'),
            ('/about/license.html', 'License')
          ),
          'About'
        ),
        (
          (
            ('/downloads/binaries.html', 'Binaries'),
            ('/downloads/sources.html','Source Code'),
            ('/downloads/vamp-plugins.html','Vamp Plug-ins'),
            ('/downloads/datasets.html', 'Datasets'),
          ),
          'Downloads'
        ),
        (
          (
            ('http://marsyas.info/assets/docs/manual/marsyas-user/index.html', 'User Manual'),
            ('http://marsyas.info/assets/docs/manual/marsyas-devel/index.html', 'Developer Manual'),
            ('http://marsyas.info/assets/docs/manual/marsyas-cookbook/index.html','Cookbook'),
            ('http://marsyas.info/assets/docs/sourceDoc/html/index.html','C++ Library Reference'),
          ),
          'Documentation'
        ),
        (
          (
            ('/community/mailing-lists.html', 'Mailing Lists'),
            ('/community/people.html', 'People'),
          ),
          'Community'
        ),
    ),
